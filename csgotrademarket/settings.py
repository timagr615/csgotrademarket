...
from csgotrademarket.config import *
...
SECRET_KEY = 'z1-9%jv^1oejnl!h0tl^cbx=$v+cf2xgprpae+803j+x8ob%)q'
...
ROOT_URLCONF = 'csgotrademarket.urls'
...
WSGI_APPLICATION = 'csgotrademarket.wsgi.application'
